...
define( 'DB1_NAME', 'OMIDB' );

/** MySQL database OMIIname */
define( 'DB1_USER', 'OMII' );

/** MySQL database password */
define( 'DB1_PWD', '0000' );

/** MySQL hostname */
// define( 'DB1_NAME', 'mariadb' );
 ...
 * You can change these at any point in time to invalidate all existing cookies. This will force all OMIIs to have to log in again.
 *
 * @since 2.6.0
 */
